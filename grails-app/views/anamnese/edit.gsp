    ...
    <body>
        <div class="nav">
            <div id="contents">
                ...
                <span class="menuButton"><g:link class="list" controller="paciente" action="list">Listar Pacientes</g:link></span>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${anamneseInstance?.version}" />
            ...
            <div class="fc1">
                <p>
                    ...
                    <g:textField  class="fc1" name="historicoFamiliar" maxlength="180" value="${anamneseInstance?.historicoFamiliar}"/>
                </p>
            </div>
                ...
                <div class="ps1">
                    ...
                    <div class="set">
                        ...
                        <g:textField class="fc1" name="medicacaoTipo" maxlength="180" value="${anamneseInstance?.medicacaoTipo}"/>
                    </div>
                </div>
                ...
                <div class="buttons">
                    <span class="span"><g:actionSubmit class="save" action="update" value="Cadastrar" /></span>
                </div>
            </g:form>
        </div>
    </body>

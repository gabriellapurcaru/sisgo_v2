                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="texto" title="${message(code: 'noticia.texto.label', default: 'Texto')}" />
                            <g:sortableColumn property="texto" title="${message(code: 'noticia.criadaEm.label', default: 'Data Criação')}" />
                    ...
                    <g:each in="${noticiaInstanceList}" status="i" var="noticiaInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: noticiaInstance, field: "texto")}</td>
                            <td>${fieldValue(bean: noticiaInstance, field: "criadaEm")}</td>

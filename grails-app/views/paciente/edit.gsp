    ...
    <body>
        <div class="form">
            ...
            <g:form method="post" >
                ...
                <div class="controls controls-row">
                    <p class="fc0">
                        ...
                        <g:select name="dia" class="span2" from="${pacienteInstance.constraints.dia.inList}" value="${pacienteInstance?.dia}" valueMessagePrefix="paciente.dia"/>
                        <g:select name="mes" class="span2" from="${pacienteInstance.constraints.mes.inList}" value="${pacienteInstance?.mes}" valueMessagePrefix="paciente.mes"/>
                        <g:select name="ano" class="span3" from="${pacienteInstance.constraints.ano.inList}" value="${pacienteInstance?.ano}" valueMessagePrefix="paciente.ano"/>
                    </p>
                ...
                <div class="buttons">
                    <g:actionSubmit class="btn btn-primary" action="update" value="Salvar" />
                </div>
            ...
            <script type="text/javascript">
                ...
                $("#telCelular").setMask("(99)9999-9999");

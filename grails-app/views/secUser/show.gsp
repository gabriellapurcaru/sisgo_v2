            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.userTenantId.label" default="User Tenant Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "userTenantId")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.primeiroNome.label" default="Primeiro Nome" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "primeiroNome")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="secUser.ultimoNome.label" default="Ultimo Nome" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: secUserInstance, field: "ultimoNome")}</td>

                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatBoolean boolean="${usuario?.ativo}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.categoria.label" default="Categoria" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: usuario, field: "categoria")}</td>
